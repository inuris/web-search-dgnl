...
{lesson:4, question:'Khi chăm sóc khách hàng, nếu gặp trường hợp khách hàng trước đây đã từng dùng mạng của VNPT phản ánh "Mạng bị chậm, hay bị quay,..", vì vậy khách hàng đã chuyển sang dùng của nhà mạng khác, NVKT nên xử lý:', answer:'Tất cả các đáp án đều đúng'}, 
{lesson:4, question:'Sau khi lắp đặt thiết bị MODEM WIFI xong, NVKT cần lưu ý với khách hàng điều gì?', answer:'Tất cả các đáp án đều đúng'}, 
{lesson:4, question:'NVKT khi thi công tại địa chỉ khách hàng nên thực hiện thế nào để thể hiện sự chuyên nghiệp?', answer:'Phục vụ khách hàng với thao tác nhanh, chính xác; Hạn chế nói chuyện riêng, hạn chế giải quyết việc khác hoặc mượn thiết bị của khách hàng; Dọn dẹp sạch sẽ tại vị trí thi công; Xin lỗi khách hàng nếu trong quá trình thi công đã làm phiền khách hàng.'}, 
{lesson:8, question:'Bảo mật trong Datamining yêu cầu', answer:'Dữ liệu có thể truy xuất riêng phần'}, 
{lesson:8, question:'Câu lệnh nào thì được sử dụng để cấu hình 1 port của Switch hoạt động ở mode Trunk?', answer:'show interface switchport'}, 
{lesson:8, question:'Khi cài đặt Hyper – V, yêu cầu Processor:', answer:'Hyper-V chỉ có thể được triển khai trên máy chủ sử dụng processor 64bit (x86-64) có hỗ trợ ảo hóa (Intel VT hay AMD-V).'}, 
{lesson:8, question:'Chọn hai đáp áp đúng khi mô tả về mạng Lan không dây (chọn 2 đáp án):', answer:'[2 chọn]\nMạng Lan không dây dễ dàng quản lý và triển.\nChúng có thể dễ dàng quản lý các chính sách di động ở mức toàn hệ thống.'}, 
{lesson:8, question:'Danh sách white list trong Spam (của chương trình MDemon) có ý nghĩa gì:', answer:'Danh sách các địa chỉ email và các miền mong muốn nhận'}, 
{lesson:8, question:'Đâu là đáp án đúng khi nói về mạng Ethernet? (Chọn 2 đáp án.)', answer:'[2 chọn]\nGiao thức 802.3\nTruyền tin trong mạng theo kiểu CSMA/CD'}, 
{lesson:6, question:'DBA đang import 1 table và 1 index từ dump file mà được export từ 1 CSDL Oracle khác. Tùy chọn nào mà DBA có để sử dụng các thống kê(statistic) từ dump file? (chọn 3 đáp án)?', answer:'[3 chọn]\nExplicitly reject all statistics\nExplicitly accept all statistics\nLet IMPORT decide if the statistics are safe; otherwise recalculate'}, 
{lesson:6, question:'Cho table được khai báo như sau,Given the table declaration below, xác nhận việc sử dụng khônghợp lệ kiểu DL timestamp trong 1 biểu thức hay chức năng(chọn 2)? CREATE TABLE TRANSACTIONS (TRANS_ID NUMBER, AMOUNT NUMBER(10,2), TRANS_START TIMESTAMP, TRANS_END TIMESTAMP, SHIP_DATE DATE, EXPIRE_DATE INTERVAL DAY(0) TO SECOND(0)); (Chọn 2 đáp án)', answer:'[2 chọn]\nTRANS_START + SHIP_DATE\nTO_TIMESTAMP(AMOUNT, ‘YY-MM-DD HH:MI:SS’)'}, 
{lesson:12, question:'Bạn nhận được một email từ Microsoft, trong đó có chứa một file đính kèm. Email nói rằng hệ điều hành Windows bạn đang sử dụng xuất hiện lỗi, bạn phải chạy chương trình được đính kèm trong email để sửa những lỗi đó. Trường hợp này bạn nên làm gì để bảo đảm an toàn?', answer:'Microsoft và nhà cung cấp thường không gửi các file qua email. Bạn Bỏ qua/xóa email đó, truy cập vào trang chủ Microsoft để cập nhật thông tin và tải phần mềm sửa lỗi (nếu có)'}, 
{lesson:12, question:'“Đây là tổng đài VNPT, chúng tôi xin thông báo quý khách hàng đang còn nợ số tiền là 8,89 triệu đồng, nếu quý khách không chuyển tiền vào tài khoản sau thì chúng tôi sẽ tiến hành khóa máy sau 2 giờ. Vui lòng bấm số 1 để nghe thông tin tài khoản, số 2 để nghe lại thông báo, số 0 để gặp tổng đài viên”. Đoạn ghi âm trên là của:', answer:'Mánh khóe lừa đảo báo nợ cước qua điện thoại cố định của tin tặc nhắm vào đối tượng người đứng tuổi, ít kiến thức.'}, 
{lesson:12, question:'Các trường hợp có thể xảy ra khi bỗng dưng người dùng phải kết nối lại wifi đang kết nối, hoặc khi thấy có 2 tên wifi bạn đang sử dụng giống nhau.', answer:'Cần nghĩ ngay đến có thể bạn là nạn nhân của tấn công giả mạo Wi-Fi (SSID Spoofing).'}, 
{lesson:12, question:'Tổ hợp phím “Window + D” dùng để làm gì?', answer:'Ẩn/hiện các cửa sổ trên màn hình máy tính'}, 
{lesson:12, question:'Khuyến nghị nào SAI khi sử dụng mật khẩu cho các tài khoản?', answer:'Sử dụng chung một mật khẩu cho nhiều tài khoản giúp người dùng dễ dàng nhớ và đảm bảo an toàn'}, 
{lesson:12, question:'Mã độc là một khái niệm chung dùng để chỉ các phần mềm độc hại được viết với mục đích:', answer:'Cả 3 đáp án đều đúng'}, 
{lesson:12, question:'Mã độc Coinhive là', answer:'Mã độc chạy dưới dạng tiện ích mở rộng hoặc trực tiếp trong trình duyệt nhằm mục đích đào tiền ảo Bitcoin'}, 
{lesson:12, question:'Locky là loại mã độc gì?', answer:'Mã độc tống tiền/Ransomware'}, 
{lesson:12, question:'Đường dẫn (URL) để thay đổi mật khẩu Email VNPT', answer:'https://mail.vnpt.vn/ecp'}, 
{lesson:12, question:'Trong quá trình thiết lập dịch vụ Internet cho khách hàng, nhân viên kỹ thuật cần thực hiện những công việc nào? Chọn 2 đáp án đúng:', answer:'[2 chọn]\nĐổi mật khẩu quản trị mặc định của modem. Việc chọn mật khẩu là theo yêu cầu của khách hàng, tuy nhiên vẫn phải đảm bảo mật khẩu đủ độ mạnh và khó đoán đối với tin tặc\nCài đặt, chọn lựa mật khẩu wifi theo yêu cầu của khách hàng, tuy nhiên vẫn phải đảm bảo mật khẩu đủ độ mạnh và khó đoán đối với tin tặc'}, 
{lesson:12, question:'Mã độc có thể được tin tặc nhúng vào trong', answer:'Cả 3 đáp án đều đúng'}, 
{lesson:12, question:'Khi sử dụng USB, để tránh làm hỏng, mất mát dữ liệu trong USB, người dùng nên:', answer:'[3 chọn]\nTránh để USB bị rơi, va đập mạnh\nTránh để USB bị ướt\nTránh để USB trong khu vực có nhiệt độ quá cao'}, 
{lesson:12, question:'Khi sử dụng mạng xã hội, các biện pháp nào giúp tăng cường bảo mật cho tài khoản:', answer:'[3 chọn]\nKích hoạt chức năng bảo mật hai yếu tố trên các trang mạng xã hội\nDùng số điện thoại làm tùy chọn khôi phục\nTận dụng các tùy chọn riêng tư của các mạng xã hội'}, 
{lesson:12, question:'Bạn nhận được một email từ bộ phận IT của công ty bạn. Email yêu cầu thông tin tài khoản và mật khẩu email của bạn để phục vụ công tác điều tra. Khi đó bạn nên làm gì?', answer:'Không cung cấp thông tin, báo lại hoặc liên hệ trực tiếp với bộ phận IT để xác minh.'}, 
{lesson:12, question:'Các kiểu sinh trắc học thường được sử dụng để xác thực người dùng là?', answer:'[3 chọn]\nDấu vân tay\nMống mắt\nKhuôn mặt'}, 
{lesson:12, question:'Trong quá trình sử dụng máy tính, một chương trình (thường là giao diện web dạng pop-up) hiện ra với thông báo máy tính đang bị xâm nhập và gặp nguy hiểm. Bạn xác định được thông báo này là giả mạo. Để tránh máy tính bị nhiễm virus, hành động phù hợp khi đó là:', answer:'[3 chọn]\nTuyệt đối không làm theo các hướng dẫn của bảng pop up\nLập tức khởi động lại máy tính, tiến hành tìm và gỡ bỏ các ứng dụng, add-on, plug-in hay extension đã vô tình hoặc cố ý bị cài đặt mà không hề hay biết.\nSử dụng chương trình diệt virus được cập nhật cơ sở dữ liệu mới nhất và quét toàn bộ máy tính.'}, 
{lesson:12, question:'Trong các tập tin dưới đây, tập tin nào có khả năng chứa virus nhất?', answer:'phongcanh.png.msi'}, 
{lesson:12, question:'Máy fax là thiết bị được sử dụng cho các doanh nghiệp. Hacker đã có thể tấn công vào hệ thống mạng của doanh nghiệp chỉ thông qua việc biết số fax, hắn có thể gửi một tập tin hình ảnh chứa các mã độc độc hại như ransomware, mã độc đào tiền ảo đến máy fax nạn nhân. Nếu máy fax được kết nối mạng, mã độc sẽ có khả năng lây lan và xâm nhập vào các hệ thống, dẫn đến những nguy cơ về gián điệp, gián đoạn dịch vụ hoặc rò rỉ thông tin. Trong quá trình sử dụng, để hạn chế, phòng ngừa tấn công, người dùng nên thực hiện', answer:'[2 chọn]\nCập nhật các bản vá mới nhất từ nhà sản xuất cho máy fax.\nCài đặt phần mềm diệt virus mạnh được cập nhật thường xuyên cho máy tính của mình.'}, 
{lesson:12, question:'Phishing là một kiểu tấn công mà tin tặc thường sử dụng bằng cách xây dựng những hệ thống lừa đảo nhằm đánh cắp các thông tin nhạy cảm, như tên đăng nhập, mật khẩu hay thông tin về các loại thẻ tín dụng của người dùng. Để nhận biết tấn công phishing trong email, những điều gì bạn nên lưu ý:', answer:'[3 chọn]\nĐịa chỉ người gửi trong email có thể bị giả mạo dễ dàng\nThông thường, tin tặc tấn công phishing nhằm lấy các thông tin cá nhân như tên tài khoản, mật khẩu, số thẻ tín dụng,…\nCác email có nội dung chứa các đường link/URLs sẽ có nguy hiểm tiềm ẩn hơn so với các email thông thường'}, 
{lesson:12, question:'Đối với các tập tin, file đính kèm email được tải về, người dùng nên thực hiện:', answer:'Quét Virus trước khi sử dụng chúng vì các tập tin, file đó có thể chứa mã độc do tin tặc tạo ra'}, 
{lesson:12, question:'Mã độc nào được thiết kế để lây lan qua các thiết bị IoT', answer:'Mirai Botnet'}, 
{lesson:12, question:'Tại sao các tổ chức lại yêu cầu người dùng phải đặt mật khẩu dài và có các ký tự, số:', answer:'[2 chọn]\nĐể các mật khẩu trở nên khó đoán\nĐể khiến tin tặc bị khó khăn khi dò tìm mật khẩu tự động'}, 
{lesson:12, question:'Phần mềm sau đây nào không phải là phần mềm chống virus?', answer:'Word'}, 
{lesson:12, question:'Dấu hiệu nhận biết thiết bị di động bị nhiễm mã độc:', answer:'[3 chọn]\nThiết bị nhanh nóng hơn khi sử dụng, nhanh hết pin bất thường\nThường xuyên bật các pop-up quảng cáo\nMột số ứng dụng lạ được cài đặt'}, 
{lesson:12, question:'Để hạn chế chia sẻ thông tin cá nhân trên facebook, đối với chức năng “Quyền riêng tư”, lựa chọn tốt nhất là', answer:'Cá nhân'}, 
{lesson:12, question:'Chính sách tài khoản nào nên được thiết lập để ngăn chặn các cuộc tấn công ác ý liên tục như tấn công dò tìm mật khẩu Brute force vào tài khoản user', answer:'Giới hạn số lần logon'}, 
{lesson:12, question:'Con trỏ chuột máy tính bỗng dưng di chuyển trên màn hình và click vào vị trí mà bạn không mong muốn. Bạn sẽ làm gì?', answer:'Ngắt kết nối mạng và gọi bộ phận IT để yêu cầu hỗ trợ'}, 
{lesson:12, question:'Trong các phương án dưới đây, chuẩn bảo mật wifi được khuyến nghị không nên sử dụng do thiếu đô an toàn bảo mật là:', answer:'WEP'}, 
{lesson:12, question:'Các dấu hiệu của một email giả mạo: Chọn nhiều phương án', answer:'[3 chọn]\nCó thể đưa ra một cảnh báo cấp bách. Ví dụ: Tài khoản của Quý khách sẽ được đóng cửa hoặc tạm đình chỉ hoặc Quý khách sẽ mất một khoản phí nếu không trả lời.\nCó thể chứa những lỗi chính tả lộ liễu. Những lỗi này cho phép các email giả mạo tránh được bộ lọc thư rác mà các nhà cung cấp dịch vụ internet sử dụng.\nCó đính kèm những đường dẫn liên kết mà thoạt nhìn tưởng là hợp pháp bởi vì chúng chứa tất cả hoặc một phần tên của công ty chính hãng. Các liên kết này có thể đưa người dùng đến các website giả mạo, tại đó yêu cầu người dùng nhập vào, xác nhận hoặc cập nhật thông tin cá nhân nhạy cảm.'}, 
{lesson:12, question:'Những biện pháp giúp quản lý mật khẩu an toàn hơn:', answer:'Tất cả các ý trên'}, 
{lesson:12, question:'Khi nghi ngờ các file có nhiễm mã độc, bạn có thể kiểm tra độ an toàn của file trên website:', answer:'Cả 2 đáp án trên đều đúng'}, 
{lesson:12, question:'Vì sao người dùng nên hạn chế sử dụng wifi công cộng?', answer:'[3 chọn]\nCó thể bị tấn công nghe lén (Man in the middle attack)\nCó thể bị tấn công lừa đảo (Phishing)\nCó thể bị tấn công giả mạo Wi-Fi (SSID Spoofing)'}, 
{lesson:12, question:'Khi xuất hiện các “pop-up” hiển thị trên máy tính hoặc trình duyệt web, nghĩa là máy tính của bạn đã bị dính mã độc, điều đó đúng hay sai?', answer:'Sai'}, 
{lesson:12, question:'Các biện pháp nên thực hiện ngay khi bạn biết mật khẩu tài khoản của bạn đã bị lộ', answer:'[3 chọn]\nLập tức đổi thông tin mật khẩu trên tất cả các tài khoản liên quan\nThông báo cho bạn bè, người thân để họ tránh đưa các thông tin cá nhân cho tin tặc\nBật tính năng xác thực 2 bước cho các tài khoản quan trọng (nếu được hỗ trợ).'}, 
{lesson:12, question:'Tại sao sinh trắc học (vân tay, mống mắt,..) là biện pháp xác thực được ưu tiên sử dụng?', answer:'Phương pháp này khó giả mạo, giúp người dùng hạn chế bị tấn công lấy cắp thông tin. Vân tay, mống mắt, giọng nói,… là đặc điểm nhận diện độc nhất với mỗi người.'}, 
{lesson:12, question:'Để phòng ngừa bị đánh cắp thông tin qua Webcam, người dùng nên thực hiện những hành động nào sau đây?', answer:'[4 chọn]\nChe webcam khi không sử dụng để tránh bị lợi dụng. Dán một miếng băng dính đen trên webcam là đơn giản nhất, và không tốn kém.\nCập nhật các phần mềm, sử dụng các phần mềm chống mã độc cũng như luôn luôn bật tường lửa\nSử dụng VPN nơi công cộng\nTắt webcam khi không sử dụng'}, 
{lesson:12, question:'Khuyến nghị nào sau đây là KHÔNG ĐÚNG khi sử dụng email', answer:'[2 chọn]\nKhi nhận được email có các đường link hay file đính kèm, cần phải truy cập các đường link đó hoặc mở các file gửi kèm trong email.\nChia sẻ địa chỉ email lên các trang mạng xã hội, nhà cung cấp dịch vụ, người quen càng nhiều càng tốt để mọi người biết đến mình.'}, 
{lesson:12, question:'Tấn công phát tán Malware là hình thức tấn công', answer:'Phát tán các phần mềm độc hại (virus, trojan, backdoor...) qua môi trường internet.'}, 
{lesson:12, question:'VPN (Virtual Private Network) là gì?', answer:'Mạng riêng ảo, giúp mã hóa các gói tin truyền đi và nhận về, tạo kết nối mạng an toàn khi người dùng/hệ thống kết nối thông qua mạng công cộng'}, 
{lesson:12, question:'Các khuyến nghị an toàn bảo mật dành cho người dùng khi sử dụng máy tính công cộng?', answer:'[3 chọn]\nTắt tính năng tự động kết nối tới mạng wifi\nNên sử dụng bàn phím ảo để tránh bị tin tặc ăn cắp thông tin tài khoản bằng keylogger.\nHạn chế truy cập vào các ứng dụng quan trọng, đặc biệt liên quan đến tài khoản ngân hàng, thẻ tín dụng, thông tin nội bộ...'}, 
{lesson:12, question:'Để tăng cường đảm bảo an toàn khi sử dụng USB, người dùng cần:', answer:'[2 chọn]\nKhóa chức năng Autorun khi sử dụng USB\nQuét virus cho USB trước khi sử dụng'}, 
{lesson:12, question:'Cơ chế làm việc của Ransomware WannaCry sau khi lây nhiễm vào máy tính nạn nhân là gì?', answer:'Quét tất cả các IP trong mạng LAN và sử dụng lỗ hổng của windows MS17-010 để lây lan toàn bộ hệ thống mạng LAN'}, 
{lesson:12, question:'Điện thoại thông minh chứa rất nhiều thông tin cá nhân, vì thế khi bán hay cho những chiếc điện thoại cũ, dễ dẫn đến việc bị lộ thông tin cá nhân, do người dùng không xoá dữ liệu đúng cách. Để xoá sạch dữ liệu trong điện thoại thông minh, cần thiết thực hiện các bước sau:', answer:'[4 chọn]\nTrước khi thực hiện xóa dữ liệu, người dùng nên thực hiện lưu trữ toàn bộ dữ liệu (bao gồm cả danh bạ), gỡ sim điện thoại và thẻ nhớ. Mã hoá và xoá dữ liệu trên thẻ nhớ nếu không dùng nó trong thiết bị mới.\nĐăng xuất các dịch vụ như thư điện tử và mạng xã hội rồi xoá dữ liệu từ các ứng dụng đó nếu được.\nKhôi phục thiết lập gốc (factory reset). Cần mã hoá dữ liệu trước khi tiến hành khôi phục thiết lập gốc để tránh trường hợp dữ liệu có thể được khôi phục bằng những công cụ khôi phục dữ liệu chuẩn.\nGỡ khoá màn hình, đăng xuất các tài khoản, dịch vụ trên điện thoại như email, Google, iCloud, iMessage, Apple ID,…'}, 
{lesson:12, question:'Máy tính của một người dùng hiển thị tên các file như hình dưới. Bạn cho rằng:', answer:'Máy của người dùng đó đã bị nhiễm mã độc. Mã độc đã đổi tên file thành các tên có đuôi .locky'}, 
{lesson:12, question:'Cú pháp nhắn tin để lấy lại mật khẩu truy cập Portal VNPT', answer:'MK <tên tài khoản> gửi 293'}, 
{lesson:12, question:'Vì sao chúng ta nên sử dụng các mật khẩu riêng biệt cho từng loại tài khoản. Chọn câu trả lời phù hợp nhất:', answer:'Để giúp cho việc tin tặc không thể truy cập vào tất cả các tài khoản trong trường hợp 1 tài khoản người dùng bị tấn công'}, 
{lesson:12, question:'Khi tiến hành cài đặt cấu hình cho modem Wifi ở nhà, người dùng nên lựa chọn cơ chế bảo mật mạng không dây nào dưới đây là an toàn nhất?', answer:'Mã hóa WAP2'}, 
{lesson:12, question:'Các biện pháp để đảm bảo an toàn khi sử dụng wifi công cộng là:', answer:'[3 chọn]\nChỉ nên truy cập các trang web HTTPS\nLuôn cập nhật bản vá mới nhất cho các chương trình, phần mềm trên thiết bị (laptop, máy tính bảng, điện thoại…)\nSử dụng cơ chế xác thực hai bước khi truy cập tài khoản.'}, 
{lesson:12, question:'Tổ hợp phím “Window + L” trên hệ điều hành Windows có tác dụng gì?', answer:'Khóa màn hình máy tính'}, 
{lesson:12, question:'Người dùng tại VNPT nhận được 1 email thông báo ứng dụng Zalo Pay mới tung ra phiên bản mới với nhiều tính năng mới, đề nghị người dùng đăng ký để nhận được nhiều phần quà ưu đãi như hình dưới. Anh/chị cho rằng điều này: Chọn các phương án phù hợp', answer:'[2 chọn]\nNghi vấn là email giả mạo do đường link khi bạn rê chuột vào đường link đăng ký lại hiển thị (https://zalopay.ga/account?...) khác với đường link được ghi trên email (https://id.zalopay.vn/account)\nNghi vấn là email giả mạo do bạn kiểm tra thấy website https://zalopay.ga không phải là website chính thức của Zalo Pay.'}, 
{lesson:12, question:'Chữ ký số được dùng cho mục đích gì', answer:'Để kiểm tra định danh người gửi'}, 
{lesson:12, question:'Spyware là', answer:'là phần mềm máy tính được cài đặt một cách lén lút lên một máy tính, có thể thu thập nhiều loại thông tin cá nhân của người sử dụng, có thể cản trở quyền điều khiển máy tính'}, 
{lesson:12, question:'Trong các mật khẩu sau, mật khẩu nào là đủ độ phức tạp.', answer:'Conan!@43'}, 
{lesson:12, question:'Để phòng chống mã độc được nhúng trong các tệp tin khi tải về từ Internet, người dùng nên tránh hành động nào sau đây?', answer:'Kích đúp vào tệp tin sau khi tải về mà chưa kiểm tra "độ sạch" của tệp tin'}, 
{lesson:12, question:'Những chú ý cần thiết khi truy cập wifi công cộng là:', answer:'Cả 3 đáp án đều đúng'}, 
{lesson:12, question:'Người dùng tại VNPT nhận được 1 email thông báo chương trình đặc biệt của VNPT nhân ngày 30/4-1/5 như hình dưới. Anh/chị cho rằng điều này:', answer:'Cả 3 phương án đều đúng'}, 
{lesson:12, question:'Luật An ninh mạng chính thức có hiệu lực vào thời gian nào', answer:'1/1/2019'}, 
{lesson:12, question:'Mật khẩu đủ mạnh bao gồm các điều kiện nào sau đây:', answer:'Cả 3 đáp án trên'}, 
{lesson:12, question:'Trang web nào là trang web cung cấp dịch vụ BHXH của VNPT', answer:'https://vnpt-bhxh.vn/'}, 
{lesson:12, question:'Các lưu ý nên áp dụng khi sử dụng máy tính công cộng. Chọn nhiều đáp án', answer:'[3 chọn]\nKiểm tra độ an toàn của phần mềm (có độc hại hay không) trước khi sử dụng\nHạn chế gửi/truyền các dữ liệu nhạy cảm khi sử dụng máy tính công cộng\nĐăng xuất sau khi kết thúc công việc'}, 
{lesson:12, question:'Dấu hiệu nhận biết máy tính bị mã độc', answer:'[3 chọn]\nMáy tính chạy không ổn định hoặc đột nhiên chạy rất chậm\nCác file và thư mục đột nhiên bị xóa hoặc bị thay đổi nội dung\nKhông truy cập được vào các Website về Security/Anti-Virus'}, 
{lesson:12, question:'Khi dùng máy tính công cộng nên thực hiện các hành động nào dưới đây để tăng cường an toàn?', answer:'[4 chọn]\nThao tác nhanh để tránh bị nhòm ngó.\nXóa lịch sử duyệt web sau khi sử dụng xong\nTránh lưu dữ liệu trên máy tính công cộng\nĐăng xuất các tài khoản, đăng xuất máy tính sau khi kết thúc công việc'}, 
{lesson:12, question:'Adware là', answer:'phần mềm được thiết kế để hiển thị quảng cáo lên màn hình thiết bị của người dùng, thường ngụy trang dưới dạng một chương trình hợp pháp hoặc ẩn mình trong một chương trình khác để lừa người dùng cài đặt nó.'}, 
{lesson:12, question:'Người dùng được khuyến cáo chỉ nên truy cập vào các website HTTPS có biểu tượng ổ khóa trên thanh địa chỉ thay vì HTTP, bởi lý do nào sau đây?', answer:'Chứng thực website là an toàn. Dữ liệu của người dùng sẽ được mã hóa khi truyền đi trên môi trường mạng'}, 
{lesson:12, question:'Bạn nhận được một email thông báo từ Google như hình dưới. Bạn có nhận xét gì về email này:', answer:'[2 chọn]\nTên email của người gửi không phải của GmailTeam\nĐường link gửi kèm trong email (Change) không trỏ đến trang web của Gmail mà trỏ đến một trang web lạ'}, 
{lesson:12, question:'Một trong những mục tiêu ưa thích hiện nay của tin tặc là lừa đảo thông qua việc gửi thư điện tử giả mạo, thư rác đến người dùng. Để phòng tránh được những hình thức tấn công này, người dùng cần có những nhận thức cơ bản và cách nhận biết về thư điện tử giả mạo, thư rác. Một số kỹ năng nhận biết đó là:', answer:'[3 chọn]\nKiểm tra thông tin Email header trong email được gửi đến. Email header là nội dung được gửi kèm theo thư điện tử (thông tin máy chủ SMTP để tiếp nhận thư điện tử, địa chỉ thư điện tử người gửi, thông tin ứng dụng được sử dụng,…) nhằm cung cấp các thông tin đầy đủ của một bức thư điện tử. Mặc định những thông tin này không được hiển thị đầy đủ cho người dùng để rút gọn không gian hiển thị.\nPhân tích địa chỉ thư điện tử để tránh các trường hợp thư điện tử giả mạo mạo danh các website tin tưởng về ngân hàng, tài chính, học tập, chính phủ,… để lừa người dùng nhấp chuột vào đường dẫn độc hại\nXem xét, kiểm tra kỹ các tệp tin tải về trước khi xem và sử dụng, tránh bị tin tặc tấn công lây lan và cài đặt phần mềm độc hại'}, 
{lesson:12, question:'Mạng xã hội Facebook rất tuyệt vời. Bạn có thể liên lạc với tất cả bạn bè và đăng tải những gì xảy ra trong cuộc sống của bạn. Khi trở thành 1 thành viên của mạng xã hội, những hành động nào dưới đây bạn nên làm theo?', answer:'Có trách nhiệm đối với thông tin đăng tải về cá nhân và người thân của bạn.'}, 
{lesson:12, question:'Mã độc nào dưới đây có tên gọi là “mã độc tống tiền”?', answer:'Ransomware'}, 
{lesson:12, question:'Các khuyến nghị khi sử dụng mạng công cộng là:', answer:'Cả 3 đáp án đều đúng'}, 
{lesson:12, question:'Độ dài mật khẩu đủ mạnh khi có ít nhất bao nhiêu ký tự?', answer:'8 ký tự'}, 
{lesson:12, question:'Khi sử dụng mạng xã hội, cần lưu ý những điều sau:', answer:'Cả 3 đáp án đều đúng'}, 
{lesson:12, question:'Trang mạng xã hội đề nghị bạn sử dụng một add-ons mở rộng để tích hợp các ứng dụng và trò chơi vào tiểu sử mạng xã hội của bạn. Việc cài đặt các add-ons đó liệu có an toàn không? Chọn câu trả lời phù hợp nhất.', answer:'Không chắc chắn, không gì đảm bảo bạn sẽ an toàn khi cài đặt chúng'}, 
{lesson:12, question:'Phương án nào không phải là dấu hiệu nhận biết máy tính bị nhiễm mã độc?.', answer:'Không lên nguồn điện khi bật khởi động máy tính'}, 
{lesson:12, question:'Việc sử dụng mạng không dây công cộng tiềm ẩn nhiều nguy cơ nghiêm trọng. Để tăng cường bảo vệ an toàn khi sử dụng wifi công cộng, người dùng nên chú ý:', answer:'[3 chọn]\nTắt wifi khi không có nhu cầu sử dụng mạng nữa\nHạn chế truy cập và điền thông tin tài khoản vào các website không được mã hóa. Các website sử dụng giao thức mã hóa HTTPS sẽ giúp bảo mật thông tin tốt hơn.\nKhi sử dụng wifi miễn phí được cung cấp ở nơi công cộng, không thực hiện thanh toán trực tuyến hay sử dụng ngân hàng trực tuyến mà không có biện pháp bảo vệ thích hợp (sử dụng VPN,…)'}, 
{lesson:12, question:'Người dùng chỉ nên cài đặt các chương trình, phần mềm được tải về từ:', answer:'Từ các trang chủ, website chính thống của chương trình, phần mềm đó'}, 
{lesson:12, question:'Social engineering là nghệ thuật điều khiển mọi người để họ tiết lộ những thông tin bí mật như mật khẩu, thông tin ngân hàng hoặc cách truy cập máy tính để cài đặt phần mềm độc hại. Các loại tấn công Social Engineering phổ biến có thể bao gồm:.', answer:'[3 chọn]\nKẻ tấn công lừa nạn nhân nghĩ rằng máy tính của anh ta bị nhiễm phần mềm độc hại hoặc vô tình tải xuống nội dung bất hợp pháp, độc hại.\nCuộc tấn công trong đó social engineering giả vờ cung cấp một cái gì đó để đổi lấy thông tin hoặc sự hỗ trợ của mục tiêu. Ví dụ, kẻ tấn công chọn ngẫu nhiên các số điện thoại trong một tổ chức và giả vờ gọi lại để hỗ trợ kỹ thuật. Thông qua điều này, hacker có thể buộc mục tiêu thêm các lệnh để khởi chạy phần mềm độc hại hoặc có thể thu thập thông tin mật khẩu.\nKẻ tấn công giả vờ là một người “hấp dẫn”, người nổi tiếng để tương tác với một người trực tuyến hoặc giả mạo một mối quan hệ trực tuyến và thu thập thông tin nhạy cảm thông qua mối quan hệ đó.'}, 
{lesson:12, question:'Khi sử dụng internet, biểu tượng ổ khóa trên các URL trình duyệt có ý nghĩa gì:', answer:'Kết nối đã được mã hóa và đảm bảo an toàn'}, 
{lesson:12, question:'Có rất nhiều wifi công cộng tại sân bay, chọn lựa nào dưới đây là kém an toàn nhất?', answer:'Tất cả đều là wifi do sân bay cung cấp, sử dụng wifi nào cũng được'}, 
{lesson:12, question:'Trong quá trình sử dụng Microsoft Office 365 tại Tập đoàn, người dùng tại VNPT nhận được email thông báo phát hiện truy cập bất thường từ một thiết bị khác. Bạn nhận định ra sao về email này:', answer:'[2 chọn]\nNghi vấn email giả mạo/lừa đảo do bạn kiểm tra email support chính thức của Microsoft Office 365 không phải là no-reply@support-office.vn như ở phần email người gửi\nNghi vấn email giả mạo do đường link gửi kèm trong email (khi rê chuột vào Check your activity) không trỏ đến trang web của Microsoft mà trỏ đến một trang web có tên tương tự là https://support-office.vn/'}, 
{lesson:12, question:'Trình duyệt tự dưng xuất hiện rất nhiều thanh công cụ (toolbar) mặc dù bạn chưa từng cài. Bạn xác định khả năng lớn máy tính đã bị tấn công. Hành động phù hợp để phòng chống trong trường hợp này là:', answer:'[2 chọn]\nTruy cập vào mục quản lý các toolbar của trình duyệt, vô hiệu hóa (disable) hoặc gỡ bỏ hoàn toàn các thanh công cụ giả mạo\nKhi cài đặt các ứng dụng, như trình duyệt hay các trình download, bạn nên đọc kỹ từng bước và bỏ chọn hoặc không đồng ý những điều khoản trong các bước cài thêm các ứng dụng bổ sung để không vô tình cài phải các công cụ không mong muốn.'}, 
{lesson:12, question:'Kiểu tấn công Non-Electronic là dạng tấn công mật khẩu nào?', answer:'Tấn công dựa vào yếu tố con người'}, 
{lesson:12, question:'Nguy cơ khi sử dụng mạng xã hội?', answer:'Cả 3 đáp án đều đúng'}, 
{lesson:12, question:'Virus là', answer:'là chương trình phần mềm độc hại được dùng để phục vụ những mục đích không tốt.'}, 
{lesson:12, question:'Biện pháp đề phòng trường hợp lộ mật khẩu do phần mềm KeyLogger (phần mềm ghi lại mọi phím bấm mà người dùng đã nhấn trên bàn phím) là:', answer:'Sử dụng bàn phím ảo khi đăng nhập'}, 
{lesson:12, question:'Người dùng công nghệ bao giờ cũng mong muốn các thiết bị máy tính, laptop của mình luôn được bảo vệ an toàn khỏi virus và các lỗ hổng bảo mật. Tuy nhiên, nhiều thói quen cơ bản hàng ngày tưởng chừng như vô hại lại hoàn toàn có thể tạo điều kiện cho các hacker bất ngờ “hỏi thăm” thiết bị của bạn:', answer:'[3 chọn]\nXem phim hoặc các chương trình TV “lậu”\nChia sẻ tài khoản của bạn cho những người khác\nCoi nhẹ việc quét mã độc cho USB'}, 
{lesson:12, question:'Bạn biết gì về tác dụng của firewall và phần mềm diệt virus. Chọn các câu trả lời đúng nhất:', answer:'[2 chọn]\nTường lửa (firewall) giúp quản lý những gì được phép vào mạng và những gì được phép ra khỏi mạng. Nó thường được sử dụng để chống sự truy cập trái phép, nhằm bảo vệ các nguồn thông tin nội bộ và hạn chế sự xâm nhập không mong muốn từ bên ngoài vào hệ thống.\nPhần mềm diệt virus tìm, cảnh báo và diệt virus (nếu có thể) trong máy tính của bạn'}, 
{lesson:12, question:'Những thói quen xấu nào khiến bạn mất an toàn khi sử dụng internet:.', answer:'[2 chọn]\nChia sẻ quá nhiều thông tin cá nhân lên mạng xã hội\nChia sẻ thông tin vị trí của bạn'}, 
{lesson:12, question:'Khi màn hình của người dùng hiển thị như hình dưới, nhận định nào phù hợp nhất:', answer:'Máy tính bị nhiễm mã độc tống tiền Ransomware'}, 
{lesson:12, question:'Một người dùng tại công ty nhận được email thông báo về việc chia sẻ hợp đồng bán hàng của đồng nghiệp mới như hình dưới, đính kèm theo mail là đường link chứa file rar tên là Draft Sale Contacts.pdf. Kiểm tra đường link trên Virustotal không phát hiện được bất cứ mã độc nào. Theo bạn, trong trường hợp này, đã có thể đảm bảo email gửi đến đó là an toàn hay chưa? Chọn các phương án phù hợp:', answer:'[2 chọn]\nEmail đó là chưa an toàn. Đường link gửi kèm đã được người dùng kiểm tra trên website Virustotal chưa đảm bảo file trong đường link đó là an toàn\nEmail đó là chưa an toàn. File gửi kèm trong đường link có biểu tượng như một file .rar nhưng lại hiển thị tên file là .pdf Một file .pdf là một điều bất thường, cần chú ý kiểm tra.'}, 
{lesson:12, question:'Tấn công Active Online là dạng tấn công mật khẩu nào?', answer:'Đoán trước mật khẩu người quản trị'}, 
{lesson:12, question:'Đối với mạng xã hội Facebook, hành động nào dưới đây là KHÔNG đảm bảo an toàn bảo mật cho người dùng?', answer:'Duy trì chế độ đăng nhập thường xuyên của tài khoản Facebook tại máy tính dùng chung'}, 
{lesson:12, question:'Đáp án nào dưới đây không làm tăng độ an toàn khi sử dụng mạng Wifi:', answer:'Thiết lập mật khẩu wifi theo số điện thoại đang dùng của bạn'}, 
{lesson:12, question:'Máy tính bị nhiễm mã độc và bị lợi dụng phục vụ các đợt tấn công DDoS gọi là gì?', answer:'Zombie'}, 
{lesson:12, question:'Trong quá trình sử dụng máy tính, người dùng nên tắt tính năng Autoplay (chức năng tự động chạy khi cắm ổ đĩa hay usb vào máy tính) trong Windows nhằm mục đích gì?', answer:'Ngăn chặn việc virus lợi dụng để tự kích hoạt chúng và lây nhiễm vào hệ thống trước khi người dùng chủ đích mở các tập tin trong đó'}, 
{lesson:12, question:'Có thể thiết lập firewall trong hệ điều hành Windows bằng cách?', answer:'[2 chọn]\nSử dụng giao điện đồ họa thông qua Control panel\nSử dụng cửa sổ dòng lệnh Command Prompt (cmd)'}, 
{lesson:12, question:'Phương án nào không phải là dấu hiệu nhận biết máy tính bị nhiễm mã độc?', answer:'Cảnh báo cáp mạng bị đứt khi kết nối Internet'}, 
{lesson:12, question:'Khi nhận được một email có đính kèm file, điều gì bạn nên chú ý để phòng ngừa rủi ro: Chọn các đáp án phù hợp:', answer:'[2 chọn]\nTất cả các file đính kèm đều có nguy cơ tiềm ẩn và có thể chứa virus độc hại, cần kiểm tra kỹ trước khi mở và sử dụng.\nCài đặt một chương trình diệt virus và đặt chế độ quét virus theo thời gian thực sẽ giảm thiểu nguy cơ bị lây nhiễm virus từ file đính kèm trong email'}, 
{lesson:12, question:'Mỗi trình duyệt web đều có chế độ duyệt web ẩn danh. Theo bạn, chế độ này mang lại lợi ích gì?', answer:'Bảo đảm tính riêng tư nơi công cộng bởi trình duyệt sẽ không lưu dữ liệu trang web, cookie và lịch sử duyệt web của người dùng hoặc thông tin đã nhập vào các biểu mẫu'}, 
{lesson:12, question:'Những khuyến nghị nào sau đây là đúng khi sử dụng wifi?', answer:'[2 chọn]\nLuôn ý thức việc sử dụng wifi công cộng như wifi ở các quán cafe, sân bay, phố đi bộ… là không đảm bảo an toàn.\nHạn chế việc chia sẽ mật khẩu wifi'}, 
{lesson:12, question:'Đáp án nào không phải mạng xã hội trên Internet?', answer:'Vnpt-ca'}, 
{lesson:12, question:'Khi cố gắng đăng nhập phần mềm quá nhiều lần, user bị tạm khóa không đăng nhập được tiếp. Tại sao', answer:'Chức năng phần mềm giúp phòng chống kẻ tấn công dò tìm mật khẩu người dùng'}, 
{lesson:12, question:'Phần mềm diệt virus nào dưới đây là của Việt Nam?', answer:'BKAV'}, 
{lesson:12, question:'Bạn nhận được 01 email từ một người rất giàu có cần sự giúp đỡ của bạn để chuyển tiền qua biên giới quốc tế. Chỉ cần với vài $, bạn đã có thể giúp anh ta và anh ta đề nghị trả cho bạn nhiều lần hơn rất nhiều so với chi phí bạn bỏ ra. Chọn câu trả lời phù hợp nhất.', answer:'Xóa email đó ngay. Bạn nhận thấy đó là một email spam nhằm đánh lừa người dùng'}, 
{lesson:12, question:'Khi cài đặt phần mềm ứng dụng trên máy tính, người dùng nên tải các bản cài đặt từ đâu? Chọn đáp án đúng nhất', answer:'Từ trang web chính thức của nhà cung cấp phần mềm'}, 
{lesson:12, question:'Biện pháp phòng ngừa tấn công mã hóa dữ liệu', answer:'Sao lưu thường xuyên các dữ liệu ra ổ cứng ngoài hoặc trên Cloud (Onedrive, Google Drive….)'}, 
{lesson:12, question:'Bạn sẽ làm gì nếu sếp bạn yêu cầu bạn gửi mật khẩu tài khoản email của bạn tại công ty cho anh/cô ấy với lý do xác thực thông tin?', answer:'Tuyệt đối không cung cấp thông tin cá nhân cho người khác'}, 
{lesson:12, question:'Những thói quen xấu nào khiến bạn mất an toàn khi sử dụng internet:', answer:'[3 chọn]\nSử dụng mật khẩu đơn giản\nSử dụng chung mật khẩu cho nhiều website khác nhau\nSử dụng các thiết lập mặc định trên tất cả mọi thứ, từ ứng dụng, mạng xã hội,…'}, 
{lesson:12, question:'Khi cấu hình mạng wifi tại nhà, việc cấu hình nên bao gồm. Chọn câu trả lời phù hợp nhất.', answer:'WPA2, mật khẩu phức tạp khó đoán biết và vô hiệu hóa tính năng WPS'}, 
{lesson:12, question:'Phương thức nào dưới đây có thể giúp người dùng đảm bảo an toàn thông tin dữ liệu truyền đi khi truy cập qua một mạng thiếu an toàn (mạng wifi công cộng, quán game,...)? Chọn phương án phù hợp nhất.', answer:'VPN'}, 
{lesson:12, question:'Tấn công Offline là dạng tấn công mật khẩu nào?', answer:'Tấn công kiểu từ điển, thay thế một vài ký tự hoặc vét cạn'}, 
{lesson:12, question:'Trong quá trình sử dụng điện thoại, khi truy cập vào các trang web, điện thoại của bạn xuất hiện cảnh báo “Điện thoại của bạn đã bị nhiễm virus và cần xóa ngay lập tức”. Hành động của bạn khi đó là gì để đảm bảo an toàn không bị mất mát dữ liệu:', answer:'[2 chọn]\nTUYỆT ĐỐI bạn KHÔNG nhấp vào nút “hủy bỏ virus – remove virus” hay bất cứ liên kết nào khác có trong thông báo cảnh báo\nThực hiện xóa dữ liệu cache của trình duyệt có thể sẽ giúp trình duyệt không hiện cảnh báo đó nữa'}, 
{lesson:12, question:'Trong quá trình sử dụng điện thoại, bạn thường xuyên sử dụng ứng dụng Whats app để gọi điện nhắn tin. Bạn nhận được một email thông báo lỡ cuộc gọi từ một người bạn như hình dưới. Bạn có nhận xét gì về email này:', answer:'[2 chọn]\nTên email gửi tới không phải là email của Whats app\nĐường link gửi kèm trong email không trỏ đến trang web của Whats app'}, 
{lesson:12, question:'Đây là địa chỉ website Facebook người dùng thường xuyên truy cập vào. Điều đó đúng hay sai ?', answer:'Sai. Website của Facebook sử dụng giao thức HTTPS'}, 
{lesson:12, question:'Các mật khẩu nào sau đây đủ mạnh?', answer:'[2 chọn]\nqu!Z#2022\nPhoung#20'}, 
{lesson:12, question:'Cổng dịch vụ 23 (telnet) thường được sử dụng nhằm đảm bảo an toàn bảo mật cho máy tính. Điều đó đúng hay sai?', answer:'Sai'}, 
{lesson:12, question:'Một laptop bị nhiễm virus, máy này không có phần mềm diệt virus và đã ngắt kết nối mạng. Biện pháp tốt nhất để sửa chữa khi đó là', answer:'Khởi động laptop, không kết nối mạng và dùng đĩa anti virus để quét'}, 
{lesson:12, question:'Những nguy cơ có thể gặp phải khi sử dụng phần mềm crack', answer:'Tất cả các phương án trên'}, 
{lesson:12, question:'Mã độc có thể lây nhiễm, và kiểm soát những loại thiết bị nào dưới đây?', answer:'Cả 3 đáp án đều đúng'}, 
{lesson:12, question:'Đối với 01 USB lạ không rõ nguồn gốc xuất xứ, không rõ nội dung bên trong, hành động phù hợp nhất của bạn là:', answer:'Không sử dụng USB đó, không cắm USB đó vào máy tính'}, 
{lesson:12, question:'Hệ điều hành nào được Tập đoàn trang bị bản quyền tập trung?', answer:'Windows 10'}, 
{lesson:12, question:'Một số cách thức nhận biết và phòng chống tấn công phishing qua website giả mạo. Chọn các phương án phù hợp', answer:'[4 chọn]\nLuôn kiểm tra đường dẫn trước khi truy cập vào một địa chỉ lạ hay trước khi điền thông tin tài khoản,... Đường dẫn của website giả mạo sẽ được làm gần giống với các website chính thống, thường sai lệch 1 ký tự hay chứa thêm 1 số ký tự từ ngữ khác\nKiểm tra SSL và chứng thư số của website để đảm bảo độ tin cậy của đường dẫn. Hầu hết các website hợp pháp đều sử dụng giao thức bảo mật SSL và chứng thư số.\nKiểm tra thanh địa chỉ để biết thông tin của tổ chức (nếu có)\nCẩn thận với tấn công homograph – tấn công từ đồng âm tên miền quốc tế. Kỹ thuật tấn công homograph lợi dụng tập hợp các từ được đánh vần giống nhau, nhưng có ý nghĩa khác nhau để tạo ra các tên miền giả mạo. Nhiều ký tự Unicode dùng để biểu diễn cho các bảng chữ cái của tiếng Hy Lạp, Cyrillic và Armenian trong các tên miền quốc tế, nếu nhìn bằng mắt thường sẽ trông không khác gì các chữ cái Latin gây dễ nhầm lẫn. Tuy nhiên, các ký tự này được máy tính xử lý như các ký tự khác nhau, trở thành các địa chỉ website hoàn toàn khác biệt.'}, 
{lesson:12, question:'Tại công ty, khi phải ra ngoài một thời gian ngắn (đi xin chữ ký lãnh đạo, đi ăn trưa,…) biện pháp nào bạn nên thực hiện. Chọn đáp án phù hợp nhất', answer:'Khóa màn hình máy tính'}, 
{lesson:12, question:'Trong các đáp án dưới đây, đáp án nào là tốt nhất để giảm thiểu các điểm yếu, lỗ hổng bảo mật trong hệ điều hành?', answer:'Cài đặt bản vá mới nhất cho hệ điều hành'}, 
{lesson:12, question:'Các bước cần thiết nên thực hiện khi bạn nhận được một tin nhắn hay một email:', answer:'[3 chọn]\nKiểm tra nguồn gốc của tin nhắn\nKiểm tra mục đích của file gửi kèm được gửi tới bạn\nKiểm tra xem thiết bị của bạn đã được cập nhật bản vá mới nhất và đã được cài đặt phần mềm chống mã độc hay chưa trước khi tải và mở bất cứ file gửi kèm nào'}, 
{lesson:12, question:'Tính đến thời điểm cuối năm 2020, chuẩn bảo mật nào của mạng WLAN (Wifi) được đánh giá là an toàn nhất:', answer:'WPA-2'}, 
{lesson:12, question:'Để đảm bảo an toàn khi sử dụng mạng không dây, người dùng cần thực hiện những thao tác nào dưới đây?', answer:'[3 chọn]\nĐổi mật khẩu quản trị mặc định\nĐổi tên hiển thị mạng wifi (SSID) mặc định\nĐặt mật khẩu wifi đủ phức tạp'}, 
{lesson:12, question:'Bạn đang thiết lập một tài khoản mạng xã hội lần đầu và rất háo hức được kết nối trực tuyến. Điều gì bạn cần biết trước khi bạn bắt đầu sử dụng tài khoản đó.', answer:'Cả 3 đáp án đều đúng'}, 
{lesson:12, question:'Theo quy định 1650/QĐ-VNPT-IT&VAS về quản lý và sử dụng thư điện tử của Tập đoàn, người dùng phải thay đổi mật khẩu ít nhất bao lâu một lần?', answer:'3 tháng'}, 
{lesson:12, question:'Trong các đáp án dưới đây, đáp án nào là ví dụ về mật khẩu mạnh?', answer:'Sử dụng một câu nói mà bạn tâm đắc. Bài hát “My heart will go on” phát hành năm 1997: Mật khẩu là Mhwg@97'}, 
{lesson:12, question:'Tính năng UAC (User Account Control) trên hệ điều hành Windows giúp:', answer:'Giúp người sử dụng quản lý và giám sát các sự thay đổi trái phép bên trong hệ thống, đảm bảo rằng tất cả các hành động này đều đã được xác nhận từ tài khoản có quyền quản trị'}, 
{lesson:12, question:'Trước khi sử dụng usb của một người khác trên máy tính, điều gì bạn nên thực hiện để đảm bảo an toàn bảo mật. Chọn các phương án phù hợp', answer:'[2 chọn]\nThực hiện quét virus cho chiếc usb trước khi truy cập và sử dụng dữ liệu trong usb\nFormat usb (nếu được cho phép) là giải pháp an toàn nhất để phòng chống mã độc có thể chứa bên trong usb.'}, 
{lesson:12, question:'Trong các tập tin dưới đây, tập tin nào có khả năng chứa virus nhất?.', answer:'picture.gif.exe'}, 
{lesson:12, question:'Nếu thường xuyên duyệt web sử dụng Mozilla Firefox, bạn nên sử dụng chức năng Master password đi kèm. Chức năng của Master password là gì?', answer:'Mỗi khi sử dụng trình duyệt Firefox để truy cập một trang web có sử dụng mật khẩu tới tài khoản, bạn sẽ được yêu cầu nhập Master password, giúp ngăn chặn việcngười dùng khác hay tin tặc truy cập vào các trang web bạn đã lưu thông tin đăng nhập trước đó'}, 
{lesson:12, question:'Social engineering là nghệ thuật điều khiển mọi người để họ tiết lộ những thông tin bí mật như mật khẩu, thông tin ngân hàng hoặc cách truy cập máy tính để cài đặt phần mềm độc hại. Các loại tấn công Social Engineering phổ biến có thể bao gồm:', answer:'[4 chọn]\nKẻ tấn công để lại một thiết bị vật lý bị nhiễm phần mềm độc hại, chẳng hạn như ổ flash USB, ở một nơi chắc chắn sẽ được tìm thấy. Sau đó, người tìm thấy sẽ sử dụng thiết bị đó, rồi cài thiết bị vào máy tính của mình và vô tình cũng làm máy bị nhiễm phần mềm độc hại.\nKẻ tấn công gửi một email lừa đảo được cải trang thành một email hợp pháp (thường giả mạo là từ một nguồn đáng tin cậy). Thông báo này nhằm lừa người nhận chia sẻ thông tin cá nhân hay thông tin tài chính hoặc nhấp vào liên kết cài đặt phần mềm độc hại.\nKẻ tấn công lừa đảo bằng giọng nói, có thể qua điện thoại để thu thập thông tin cá nhân và thông tin tài chính từ mục tiêu.\nKẻ tấn công muốn truy cập vào dữ liệu đặc quyền. Ví dụ, kẻ tấn công giả vờ cần dữ liệu cá nhân hoặc thông tin tài chính để xác nhận danh tính của người nhận.'}, 
{lesson:12, question:'Trên đường đi tới công ty, bạn nhặt được một chiếc usb khá mới. Bạn muốn lấy usb đó tới công ty để sử dụng. Hành động gì nên thực hiện khi sử dụng usb đó?', answer:'Format usb hoặc quét virus usb trước khi sử dụng để đảm bảo usb không chứa các file độc hại'}, 
{lesson:12, question:'Khi xác định máy tính của mình vừa mới bị nhiễm mã độc tống tiền Ransomware, hành động phù hợp nhất để hạn chế tác hại của mã độc khi phát hiện ra là:', answer:'Lập tức ngắt kết nối mạng, tắt nguồn máy tính và liên hệ với cán bộ quản trị IT để được hỗ trợ giải quyết'}, 
{lesson:12, question:'WannaCry là tên của:', answer:'Một loại mã độc tống tiền'}, 
{lesson:12, question:'Mật khẩu có nguy cơ bị đánh cắp thường vì lý do nào sau đây?', answer:'Cả 3 đáp án đều đúng'}
];
